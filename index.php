...
<section class="gallery-section" id="gallery">
  ...
  <h1>Gallery:</h1> <!--/ Gallery section -->
    ...
    <h3>Before:</h3> <!--/ Before services photos -->

      <img src="images/before/katie.png" width="200" alt="cut grass"/> <br>

      <img src="images/before/terry.png" width="200" alt="before terry's grass"/> <br>  

      <img src="images/before/terry_hill.png" width="200" alt="before terry's grass hill"/> <br>
     <!---
      <img src="images/before/andrew.png" width="200" alt="before andrew's grass"/> <br>
          -->
    </div>


    <div class="after-side">
    <h3>After:</h3> <!--/ After services photos -->

      <img src="images/after/katie.png" width="200" alt="after katie's grass"/>

      <img src="images/after/terry.png" width="200" alt="after terry's grass"/>

      <img src="images/after/andrew.png" width="200" alt="after andrew's grass"/>
  </div> 
</section>
